...
function cfu_widgets_init() {
	register_sidebar(
		array(
			...
			'before_widget' => '<div id="%1$s" class="widget %2$s cfu_sidebar-widget cfu_sidebar min-h-[250px] overflow-hidden rounded-lg bg-white dark:bg-white/5 inset-ring inset-ring-gray-950/5 dark:inset-ring-white/5 shadow-xs">',
			'after_widget'  => '</div>',
